  ...
  return (
    <>
      <Seo
        ...
        description="Reserve a portrait, street, landscape, or event photography session with Jad Daou in Beirut. Availability and booking details are coming soon right here."
      />
      <Navbar />
